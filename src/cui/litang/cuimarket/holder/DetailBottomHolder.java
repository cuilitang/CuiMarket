...
import cui.litang.cuimarket.widget.ProgressHorizontal;


public class DetailBottomHolder extends BaseHolder<AppInfo> implements OnClickListener, DownloadManager.DownloadObserver {
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.detail_progress:
				...
				} else if (mState == DownloadManager.STATE_WAITING || mState == DownloadManager.STATE_DLOWNLOADING) {
